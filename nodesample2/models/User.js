...
UserSchema 	= new Schema({
	...
	email_address: {
		...
		sparse: true,
		//partialFilterExpression:  { email_address: {$exists:true} },
		uniqueCaseInsensitive:true,
        required: [function() { return this.role != 'student'; },"Email is required"],
		validate: {
	...
	contact_telephoneno: {
		...
		required:[function() { return this.role != 'student'; },"Contact telephone is required"],
		maxlength: [20, 'Contact Telephone No cannot be more than {MAXLENGTH} characters.']
	},	
	role: {
		type: String,
		enum: {
			values: ['superadmin', 'schooladmin', 'teacher','student','parent'],
